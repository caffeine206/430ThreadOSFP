...
public class SysLib {
    ...
    // opens the file specified by the fileName string in the given mode (where "r" = ready only, "w" = write only,
    // "w+" = read/write, "a" = append), and allocates a new file descriptor, fd to this file.
